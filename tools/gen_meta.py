...
INTFS = [
    ...
    ("engine", "ZIF_HDDT_LOG_SINK", "HDDT: Hop dong day log sang bang log dung chung"),
...
CLASSES = [
    ...
    ("engine", "ZCL_HDDT_SRC_GOM", "HDDT: Doc hoa don gom nhieu chung tu", False, False, None),
    ("engine", "ZCL_HDDT_GOM", "HDDT: Gom / go gom chung tu", True, False, None),
...
PROGS = [
    ...
    ("ui", "ZPG_HDDT_SETUP", "1", [
        ...
        ("S", "P_MAG", "Tham số riêng FS MAG v0.5"),
...
MESSAGES = [
    ...
    ("013", "Chọn chứng từ cần tích hợp hoá đơn"),
    ("014", "Không thể tích hợp chứng từ đã huỷ"),
    ("015", "Chứng từ đã có hoá đơn nháp trên hệ thống HĐĐT, bấm Hủy HĐ nháp trước"),
    ("016", "Hoá đơn đã phát hành"),
    ("017", "Chứng từ chưa có hoá đơn nháp, bấm Tích hợp HĐ trước khi phát hành"),
    ("018", "Không thể huỷ hoá đơn đã phát hành, dùng chức năng điều chỉnh hoặc thay thế"),
    ("019", "Chỉ chọn 1 chứng từ điều chỉnh"),
    ("020", "Hoá đơn bị điều chỉnh không hợp lệ"),
    ("021", "Chứng từ đang có hoá đơn nháp chưa phát hành, không gắn được hoá đơn gốc"),
    ("022", "Hoá đơn chưa được Cơ quan thuế chấp nhận"),
    ("023", "Đã gửi email hoá đơn tới &1"),
    ("024", "Chọn ít nhất 2 chứng từ cần gom"),
    ("025", "Có số chứng từ đã được gom"),
    ("026", "Mã khách hàng không đồng nhất để gom"),
    ("027", "Không được gom khác loại tiền"),
    ("028", "Đã gom &1 chứng từ vào &2"),
    ("029", "Chứng từ chưa được gom"),
    ("030", "Đã gỡ gom &1"),
    ("031", "Không thể gom/gỡ gom chứng từ ở trạng thái &1"),
    ("032", "Bạn không có quyền thực hiện &1"),
    ("033", "Phát hành tự động chỉ chạy ở chế độ background job, tuỳ chọn bị bỏ qua"),
    ("034", "Đã cập nhật ngày/giờ phát hành, tên hàng cho &1 chứng từ"),
    ("035", "Đã huỷ hoá đơn nháp"),
    ("036", "Đã gắn hoá đơn gốc &1/&2 (loại &3) cho chứng từ"),
    ("037", "Thiếu dữ liệu bắt buộc: &1"),
    ("038", "Chứng từ đã được gom vào &1, thao tác trên chứng từ gom"),
    ("039", "Chứng từ đã bị Cơ quan thuế từ chối, xử lý bằng điều chỉnh/thay thế"),
    ("040", "Bạn có chắc chắn huỷ hoá đơn nháp này không?"),
    ("041", "Chọn chứng từ cần cập nhật"),
    ("042", "Hoá đơn đã bị huỷ"),
    ("043", "Phát hành tự động: &1 thành công, &2 lỗi, &3 bỏ qua"),
    ("044", "Không thể cập nhật hoá đơn điều chỉnh với chứng từ này"),
    ("045", "Chứng từ gốc phải ở trạng thái đã phát hành hoặc đã được CQT cấp mã"),
]
