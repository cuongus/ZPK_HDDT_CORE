*=====================================================================
* Tên/Mã     : ZCL_HDDT_PLATFORM
* Mô tả chung: Bộ giải quyết nền tảng. Trả về đối tượng thực thi
*              ZIF_HDDT_PLATFORM phù hợp với hệ đang chạy:
*                - Khai tham số PLATFORM_CLASS trong ZTB_HDDT_PARM
*                  (ví dụ ZCL_HDDT_PLAT_CLOUD trên Public Cloud);
*                - Không khai => dùng ZCL_HDDT_PLAT_CLASSIC.
*              Nhờ lớp này, adapter nhà cung cấp (ZCL_HDDT_PROV_*) và
*              bộ JSON dùng CHUNG được cho cả Private Cloud và Public
*              Cloud mà không có một dòng IF nào theo nền tảng.
* Tham Số    : ZCL_HDDT_PLATFORM=>GET( )
*=====================================================================
...
CLASS zcl_hddt_platform DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_parm_platform TYPE zde_hddt_parmkey
                               VALUE 'PLATFORM_CLASS' ##NO_TEXT.
    CONSTANTS gc_class_classic TYPE zde_hddt_class
                               VALUE 'ZCL_HDDT_PLAT_CLASSIC' ##NO_TEXT.
    ...
    CLASS-METHODS inject
      IMPORTING io_platform TYPE REF TO zif_hddt_platform .
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA mo_platform TYPE REF TO zif_hddt_platform .
  ...
  METHOD get.
    ...
    TRY.
      ...
      CATCH cx_sy_create_object_error cx_sy_move_cast_error.
        ...
        CREATE OBJECT mo_platform TYPE zcl_hddt_plat_classic.
    ENDTRY.
