...
*
*              Lớp thực thi khai trong ZTB_HDDT_PARM, tham số
...
*---------------------------------------------------------------------*
  ...
  METHODS xstring_to_string
    IMPORTING i_data        TYPE xstring
              i_encoding    TYPE string DEFAULT `UTF-16BE`
...
*---------------------------------------------------------------------*
  ...
  METHODS decode_base64
    IMPORTING i_encoded     TYPE string
    RETURNING VALUE(r_data) TYPE xstring .
...
*---------------------------------------------------------------------*
  ...
  METHODS get_time_zone
    RETURNING VALUE(r_tzone) TYPE timezone .
