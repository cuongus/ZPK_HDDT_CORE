*=====================================================================
* Tên/Mã     : ZFIR_HDDT_CONFIG  (transaction ZFI_HDDT_CFG)
...
*=====================================================================
REPORT zfir_hddt_config MESSAGE-ID zfie_hddt.
...
CLASS lcl_cfg IMPLEMENTATION.
  ...
  METHOD maintain.
    ...
    CASE sy-subrc.
      ...
      WHEN 8 OR 13.
        MESSAGE e006(zfie_hddt) WITH iv_tabname.
      WHEN 7 OR 9 OR 4 OR 10.
        MESSAGE e007(zfie_hddt) WITH iv_tabname.
      WHEN OTHERS.
        MESSAGE e008(zfie_hddt) WITH iv_tabname sy-subrc.
    ENDCASE.
